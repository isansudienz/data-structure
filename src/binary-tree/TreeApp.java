...
package com.mycompany.practicum7;
...
class TreeApp {
    static class Node {
     ...
     static class Stack {
        ...
        public Stack() {
            maxSize = 100; // Ukuran maksimum stack
            stackArray = new Node[maxSize];
            top = -1; // Inisialisasi stack kosong
        }

        public void push(Node node) {
            stackArray[++top] = node; // Menambahkan node ke stack
        }

        public Node pop() {
            return stackArray[top--]; // Mengambil dan menghapus node dari stack
        }

        public boolean isEmpty() {
            return (top == -1); // Memeriksa apakah stack kosong
        }
    }
            ...
            switch (choice) {
                ...
                case 'i':
                    ...
                    if(theTree.find(value)!=null){
                        System.out.println("value duplicate exist");
                        break;
                    }
                ...
                case 'x':
                    if(theTree.getMax() == -1){
                        ...
                        System.out.println("Maximum value: " + theTree.getMax());
                    }
                    break;
                case 'n':
                    if(theTree.getMin() == -1){
                        ...
                        System.out.println("Minimum value: " + theTree.getMin());
                    }
                    break;
                default:
